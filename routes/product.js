...
const { addProductSchema, getProductSchema, searchProductSchema } = require("../validation/product")
...
router.post("/add", authentication, validation(addProductSchema), upload.single("image"), product.addProduct)
